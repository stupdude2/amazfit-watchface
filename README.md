...
## v2.4.2 clock auto-contrast refinement
...
## v2.4.2 — Runtime Free / Pro licensing foundation
...
## v2.4.2 — Real KiezelPay entitlement integration
...
## v2.4.2 — KiezelPay auto-purchase/state fix
...
## v2.4.2 — Explicit trial and purchase controls
...
## v2.4.2 — Trial reinstall protection
...
## v2.4.2 — Conditional bar state-machine fix
...
## v2.4.2 — Deterministic Peek State
...
## v2.4.2 — Entitlement-safe settings + hardened Peek
...
## v2.4.2 — Peek on watchface return
...
## v2.4.2 — Reliable Peek on return
...
## v2.4.2 — System Backlight Visibility
...
## v2.4.2 — Five-second sunlight fallback
...
## v2.4.2 — One-time trial enforcement
...
## v2.4.2 — Preserve trial configuration through purchase
