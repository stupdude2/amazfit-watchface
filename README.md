...
## v2.4.4 clock auto-contrast refinement
...
## v2.4.4 — Runtime Free / Pro licensing foundation
...
## v2.4.4 — Real KiezelPay entitlement integration
...
## v2.4.4 — KiezelPay auto-purchase/state fix
...
## v2.4.4 — Explicit trial and purchase controls
...
## v2.4.4 — Trial reinstall protection
...
## v2.4.4 — Conditional bar state-machine fix
...
## v2.4.4 — Deterministic Peek State
...
## v2.4.4 — Entitlement-safe settings + hardened Peek
...
## v2.4.4 — Peek on watchface return
...
## v2.4.4 — Reliable Peek on return
...
## v2.4.4 — System Backlight Visibility
...
## v2.4.4 — Five-second sunlight fallback
...
## v2.4.4 — One-time trial enforcement
...
## v2.4.4 — Preserve trial configuration through purchase
...
## v2.4.4 — Purchased Pro entitlement synchronization
