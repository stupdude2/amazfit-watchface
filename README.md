...
## v2.4.3 clock auto-contrast refinement
...
## v2.4.3 — Runtime Free / Pro licensing foundation
...
## v2.4.3 — Real KiezelPay entitlement integration
...
## v2.4.3 — KiezelPay auto-purchase/state fix
...
## v2.4.3 — Explicit trial and purchase controls
...
## v2.4.3 — Trial reinstall protection
...
## v2.4.3 — Conditional bar state-machine fix
...
## v2.4.3 — Deterministic Peek State
...
## v2.4.3 — Entitlement-safe settings + hardened Peek
...
## v2.4.3 — Peek on watchface return
...
## v2.4.3 — Reliable Peek on return
...
## v2.4.3 — System Backlight Visibility
...
## v2.4.3 — Five-second sunlight fallback
...
## v2.4.3 — One-time trial enforcement
...
## v2.4.3 — Preserve trial configuration through purchase
...
## v2.4.3 — Purchased Pro entitlement synchronization
