...
## v2.2.2 clock auto-contrast refinement
...
## v2.2.2 — Runtime Free / Pro licensing foundation
...
## v2.2.2 — Real KiezelPay entitlement integration
...
## v2.2.2 — KiezelPay auto-purchase/state fix
...
## v2.2.2 — Explicit trial and purchase controls
...
## v2.2.2 — Trial reinstall protection
...
## v2.2.2 — Conditional bar state-machine fix
...
## v2.2.2 — Deterministic Peek State
...
## v2.2.2 — Entitlement-safe settings + hardened Peek
...
## v2.2.2 — Peek on watchface return
...
## v2.2.2 — Reliable Peek on return
