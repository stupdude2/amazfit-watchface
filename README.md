...
## v2.0.16 clock auto-contrast refinement
...
## v2.0.16 — Runtime Free / Pro licensing foundation
...
## v2.0.16 — Real KiezelPay entitlement integration
...
## v2.0.16 — KiezelPay auto-purchase/state fix
...
## v2.0.16 — Explicit trial and purchase controls
...
## v2.0.16 — Trial reinstall protection
...
## v2.0.16 — Conditional bar state-machine fix
