...
## v2.2.1 clock auto-contrast refinement
...
## v2.2.1 — Runtime Free / Pro licensing foundation
...
## v2.2.1 — Real KiezelPay entitlement integration
...
## v2.2.1 — KiezelPay auto-purchase/state fix
...
## v2.2.1 — Explicit trial and purchase controls
...
## v2.2.1 — Trial reinstall protection
...
## v2.2.1 — Conditional bar state-machine fix
...
## v2.2.1 — Deterministic Peek State
...
## v2.2.1 — Entitlement-safe settings + hardened Peek
...
## v2.2.1 — Peek on watchface return
