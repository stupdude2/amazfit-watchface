...
## v2.4.6 clock auto-contrast refinement
...
## v2.4.6 — Runtime Free / Pro licensing foundation
...
## v2.4.6 — Real KiezelPay entitlement integration
...
## v2.4.6 — KiezelPay auto-purchase/state fix
...
## v2.4.6 — Explicit trial and purchase controls
...
## v2.4.6 — Trial reinstall protection
...
## v2.4.6 — Conditional bar state-machine fix
...
## v2.4.6 — Deterministic Peek State
...
## v2.4.6 — Entitlement-safe settings + hardened Peek
...
## v2.4.6 — Peek on watchface return
...
## v2.4.6 — Reliable Peek on return
...
## v2.4.6 — System Backlight Visibility
...
## v2.4.6 — Five-second sunlight fallback
...
## v2.4.6 — One-time trial enforcement
...
## v2.4.6 — Preserve trial configuration through purchase
...
## v2.4.6 — Purchased Pro entitlement synchronization
...
## v2.4.6 — Synchronize Big Time with validated KiezelPay status
...
## v2.4.6 — Faster Purchased Pro settings
