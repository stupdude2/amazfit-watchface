...
## v2.4.5 clock auto-contrast refinement
...
## v2.4.5 — Runtime Free / Pro licensing foundation
...
## v2.4.5 — Real KiezelPay entitlement integration
...
## v2.4.5 — KiezelPay auto-purchase/state fix
...
## v2.4.5 — Explicit trial and purchase controls
...
## v2.4.5 — Trial reinstall protection
...
## v2.4.5 — Conditional bar state-machine fix
...
## v2.4.5 — Deterministic Peek State
...
## v2.4.5 — Entitlement-safe settings + hardened Peek
...
## v2.4.5 — Peek on watchface return
...
## v2.4.5 — Reliable Peek on return
...
## v2.4.5 — System Backlight Visibility
...
## v2.4.5 — Five-second sunlight fallback
...
## v2.4.5 — One-time trial enforcement
...
## v2.4.5 — Preserve trial configuration through purchase
...
## v2.4.5 — Purchased Pro entitlement synchronization
...
## v2.4.5 — Synchronize Big Time with validated KiezelPay status
