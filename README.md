...
## v2.3.0 clock auto-contrast refinement
...
## v2.3.0 — Runtime Free / Pro licensing foundation
...
## v2.3.0 — Real KiezelPay entitlement integration
...
## v2.3.0 — KiezelPay auto-purchase/state fix
...
## v2.3.0 — Explicit trial and purchase controls
...
## v2.3.0 — Trial reinstall protection
...
## v2.3.0 — Conditional bar state-machine fix
...
## v2.3.0 — Deterministic Peek State
...
## v2.3.0 — Entitlement-safe settings + hardened Peek
...
## v2.3.0 — Peek on watchface return
...
## v2.3.0 — Reliable Peek on return
...
## v2.3.0 — System Backlight Visibility
