...
## v2.4.1 clock auto-contrast refinement
...
## v2.4.1 — Runtime Free / Pro licensing foundation
...
## v2.4.1 — Real KiezelPay entitlement integration
...
## v2.4.1 — KiezelPay auto-purchase/state fix
...
## v2.4.1 — Explicit trial and purchase controls
...
## v2.4.1 — Trial reinstall protection
...
## v2.4.1 — Conditional bar state-machine fix
...
## v2.4.1 — Deterministic Peek State
...
## v2.4.1 — Entitlement-safe settings + hardened Peek
...
## v2.4.1 — Peek on watchface return
...
## v2.4.1 — Reliable Peek on return
...
## v2.4.1 — System Backlight Visibility
...
## v2.4.1 — Five-second sunlight fallback
...
## v2.4.1 — One-time trial enforcement
