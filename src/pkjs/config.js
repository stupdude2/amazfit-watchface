  ...
  config.push({
    ...
    "items": [
      ...
      { "type": "toggle", "messageKey": "BLUETOOTH_COLON", "defaultValue": false,
        ...
        "description": "Digital: bottom colon dot. Analog: dash beside 3. Filled when connected; outlined when disconnected." },
      { "type": "toggle", "messageKey": "QUIET_TIME_INDICATOR", "defaultValue": false,
        "label": "Quiet Time Indicator",
        "description": "Digital: top colon dot. Analog: dash beside 9. Outlined while Quiet Time is enabled." },
